...
SUDO = SUDO
sudo_users = {SUDO,1450865400,1397042354}   
print([[
> CH › @f55f5
~> DEVELOPER › @ckcck
]])
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LODKN/Fails/main/File_Bot/commands.lua") 
...
function TEAMLODKNSudoBot(sudo)  
local TEND = false  
for k,v in pairs(sudo_users) do  
...
if hash or SudoBot(msg) or DevTEAMLODKNW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTEAMLODKNW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTEAMLODKNW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTEAMLODKNW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTEAMLODKNW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTEAMLODKNW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTEAMLODKNW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1450865400) then  
var = true  
elseif tonumber(user_id) == tonumber(1397042354) then
var = true  
...
local UserName = (data.username_ or "f55f5")
...
local TEAMLODKN_Msg = ''  
if msgs < 100 then 
TEAMLODKN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
TEAMLODKN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
TEAMLODKN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
TEAMLODKN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
TEAMLODKN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
TEAMLODKN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
TEAMLODKN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
TEAMLODKN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
TEAMLODKN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
TEAMLODKN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TEAMLODKN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TEAMLODKN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
TEAMLODKN_Msg = 'رب التفاعل'  
end 
return TEAMLODKN_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@ckcck")  
...
--------------------------------------------------------------------------------------------------------------
function SourceTEAMLODKN(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if start then 
SourceTEAMLODKNr = start
else
Namot = (database:get(bot_id..'Name:Bot') or 'لودكن')
SourceTEAMLODKNr = '*♰︙اهلا عزيزي*\n*♰︙انا بوت اسمي '..Namot..'*\n*♰︙اختصاصي حمايه الكروبات*\n*♰︙من تكرار والسبام والتوجيه والخ…*\n*♰︙لتفعيلي اتبع الاخطوات…↓*\n*♰︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n♰︙[قناة سورس البوت](http://t.me/f55f5)'
end
send(msg.chat_id_, msg.id_, SourceTEAMLODKNr) 
end
end
...
local list = database:smembers(bot_id.."TEAMLODKN1:List:Filter"..sl)
...
if not DevTEAMLODKNW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevTEAMLODKNW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,TEAMLODKN_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ♰' and DevTEAMLODKNW(msg) then  
...
if text == 'تعطيل التواصل ♰' and DevTEAMLODKNW(msg) then  
...
if text == 'تفعيل البوت الخدمي ♰' and DevTEAMLODKNW(msg) then  
...
if text == 'تعطيل البوت الخدمي ♰' and DevTEAMLODKNW(msg) then  
...
if text == 'ضع كليشه ستارت ♰' and DevTEAMLODKNW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *♰︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ♰' and DevTEAMLODKNW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *♰︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ♰' and DevTEAMLODKNW(msg) then 
...
if text == 'تحديث السورس ♰' and DevTEAMLODKNW(msg) then 
...
if text == 'الاصدار ♰' and DevTEAMLODKNW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *♰︙اصدار سورس لودكن* \n*♰︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ♰' and DevTEAMLODKNW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♰︙[تحديثات البوت](t.me/lodkn) \n♰︙[قناه السورس](t.me/f55f5)')
end
if text == "ضع اسم للبوت ♰" and DevTEAMLODKNW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *♰︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ♰' and DevTEAMLODKNW(msg) then 
...
if text == 'المشتركين ♰' and DevTEAMLODKNW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *♰︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ♰' and DevTEAMLODKNW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *♰︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ♰") and DevTEAMLODKNW(msg) then
...
if text == ("قائمه العام ♰") and DevTEAMLODKNW(msg) then
...
if text == ("قائمه الكتم العام ♰") and DevTEAMLODKNW(msg) then
...
if text=="اذاعه خاص ♰" and msg.reply_to_message_id_ == 0 and DevTEAMLODKNW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *♰︙ارسل الان اذاعتك؟* \n*♰︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ♰" and msg.reply_to_message_id_ == 0 and DevTEAMLODKNW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *♰︙ارسل الان اذاعتك؟* \n*♰︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ♰" and msg.reply_to_message_id_ == 0 and DevTEAMLODKNW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *♰︙ارسل الان اذاعتك؟* \n*♰︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ♰" and msg.reply_to_message_id_ == 0  and DevTEAMLODKNW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *♰︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ♰" and msg.reply_to_message_id_ == 0  and DevTEAMLODKNW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♰︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ♰' and DevTEAMLODKNW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ♰" and DevTEAMLODKNW(msg) then
...
if text == "تنظيف الكروبات ♰" and DevTEAMLODKNW(msg) then 
...
send(msg.chat_id_, msg.id_,'*♰︙عدد الكروبات الان » { '..#group..' }'..TEAMLODKNk..''..TEAMLODKN..'*\n*♰︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevTEAMLODKNW(msg) then
...
usertext = '*\n ♰︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'f55f5')..')'
status  = '\n *♰︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevTEAMLODKNW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *♰︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'f55f5')..')'
status  = '\n*♰︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTEAMLODKNW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTEAMLODKNW(msg) then
...
local TEAMLODKN1_Msg = database:get(bot_id.."TEAMLODKN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TEAMLODKN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *♰︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'f55f5')..') \n ♰︙'..TEAMLODKN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if TEAMLODKN_Msg and not Special(msg) then  
local TEAMLODKN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TEAMLODKN_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *♰︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n♰︙["..TEAMLODKN_Msg.."] \n")
else
send(msg.chat_id_,0," *♰︙العضو :* {["..data.first_name_.."](T.ME/f55f5)}\n♰︙["..TEAMLODKN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *♰︙عذرا ↫* {["..data.first_name_.."](T.ME/f55f5)}\n*♰︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTEAMLODKNW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevTEAMLODKNW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevTEAMLODKNW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *♰︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevTEAMLODKNW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *♰︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ♰" and DevTEAMLODKNW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *♰︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ♰$") and DevTEAMLODKNW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *♰︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ♰" and DevTEAMLODKNW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ♰" and DevTEAMLODKNW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *♰︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ♰" and DevTEAMLODKNW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."TEAMLODKN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."TEAMLODKN:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_TEAMLODKN = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_TEAMLODKN then 
names_TEAMLODKN = database:smembers(bot_id.."TEAMLODKN:blocname"..msg.chat_id_) or ""
if names_TEAMLODKN and names_TEAMLODKN[1] then 
for i=1,#names_TEAMLODKN do 
if name_TEAMLODKN:match("(.*)("..names_TEAMLODKN[i]..")(.*)") then 
...
database:set(bot_id.."TEAMLODKN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."TEAMLODKN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."TEAMLODKN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."TEAMLODKN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."TEAMLODKN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_TEAMLODKNa_new(TEAMLODKN1,TEAMLODKN2)
if TEAMLODKN2 and TEAMLODKN2.first_name_ then 
if TEAMLODKN2.first_name_:match("(.*)"..database:get(bot_id.."TEAMLODKN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."TEAMLODKN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local TEAMLODKN_nnn = database:get(bot_id.."TEAMLODKN:nump"..msg.chat_id_) or 5
local TEAMLODKN_nnn2 = database:get(bot_id.."TEAMLODKN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(TEAMLODKN_nnn2) == tonumber(TEAMLODKN_nnn) or tonumber(TEAMLODKN_nnn2) > tonumber(TEAMLODKN_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."TEAMLODKN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "♰︙عزيزي >>["..TEAMLODKN2.username_.."](https://t.me/"..(TEAMLODKN2.username_ or "f55f5")..")\n♰︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."TEAMLODKN:teh"..msg.chat_id_).."} بجانب اسمك\n♰︙عدد المحاولات المتبقيه {"..(tonumber(TEAMLODKN_nnn) - tonumber(TEAMLODKN_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_TEAMLODKNa_new)
end
end
...
local TEAMLODKNChengName = database:get(bot_id.."TEAMLODKN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TEAMLODKNChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TEAMLODKNChengName..']')
database:del(bot_id.."TEAMLODKN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if TEAMLODKNChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."TEAMLODKN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TEAMLODKNChengUserName = database:get(bot_id.."TEAMLODKN:Cheng:UserName"..data.id_)
if not data.username_ then 
if TEAMLODKNChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..TEAMLODKNChengUserName..']')
database:del(bot_id.."TEAMLODKN:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if TEAMLODKNChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."TEAMLODKN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TEAMLODKNChengPhoto = database:get(bot_id.."TEAMLODKN:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TEAMLODKNChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."TEAMLODKN:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if TEAMLODKNChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."TEAMLODKN:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevTEAMLODKNW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*♰︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'f55f5')..') \n*♰︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *♰︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'f55f5')..') \n*♰︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ ريـك 
if text == 'تحديث' and DevTEAMLODKNW(msg) then
dofile('LoDkn.lua')  
send(msg.chat_id_, msg.id_, ' *♰︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevTEAMLODKNW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevTEAMLODKNW(msg) then  
function start_function(extra, result, success)
if TEAMLODKNSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevTEAMLODKNW(msg) then  
...
if TEAMLODKNSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*♰︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevTEAMLODKNW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if TEAMLODKNSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*♰︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevTEAMLODKNW(msg) then  
function start_function(extra, result, success)
if TEAMLODKNSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*♰︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevTEAMLODKNW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevTEAMLODKNW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if TEAMLODKNSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*♰︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevTEAMLODKNW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevTEAMLODKNW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevTEAMLODKNW(msg) then  
...
------------------------------------------------------------------------ ريـك 
if text == ("مسح المطورين") and DevTEAMLODKNW(msg) then
...
if text == 'الملفات' and DevTEAMLODKNW(msg) then
t = ' *♰︙ملفات السورس لودكن ↓*\n*•━━━━━━ 𝖫ꪀ ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n *♰︙اهلا بك في متجر ملفات لودكن*\n*♰︙ملفات السورس ↓*\n*•━━━━━━ 𝖫ꪀ ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝖫ꪀ ━━━━━━━•*\n *♰︙علامة تعني { ✓ } ملف مفعل*\n *♰︙علامة تعني { ✘ } ملف معطل*\n *♰︙قناة سورس لودكن ↓*\n".." *♰︙*[اضغط هنا لدخول](t.me/f55f5) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevTEAMLODKNW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LODKN/Files_TEAMLODKN/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('LoDkn.lua')  
else
send(msg.chat_id_, msg.id_," *♰︙عذرا الملف لايدعم سورس لودكن* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevTEAMLODKNW(msg) then
...
if text == "مسح الملفات" and DevTEAMLODKNW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *♰︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevTEAMLODKNW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevTEAMLODKNW(msg) then  
function start_function(extra, result, success)
...
function Function_TEAMLODKN(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TEAMLODKN, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_TEAMLODKN, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *♰︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'f55f5')..')'
status  = '\n*♰︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *♰︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'f55f5')..')'
status  = '\n*♰︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *♰︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *♰︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'f55f5')..')'
...
database:set(bot_id.."TEAMLODKN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TEAMLODKN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *♰︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."TEAMLODKN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TEAMLODKN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TEAMLODKN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TEAMLODKN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *♰︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."TEAMLODKN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TEAMLODKN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TEAMLODKN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TEAMLODKN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *♰︙ارسل الكلمه الان*")  
database:set(bot_id.."TEAMLODKN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TEAMLODKN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TEAMLODKN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TEAMLODKN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TEAMLODKN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TEAMLODKN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TEAMLODKN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TEAMLODKN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TEAMLODKN1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevTEAMLODKNW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *♰︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevTEAMLODKNW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *♰︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'f55f5')..')'..'\n*♰︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevTEAMLODKNW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevTEAMLODKNW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'لودكن').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'لودكن')
local TEAMLODKN_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..TEAMLODKN_Msg[math.random(#TEAMLODKN_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevTEAMLODKNW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,TEAMLODKN)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝖫ꪀ ━━━━━━━•*\n"
x = 0
local list = TEAMLODKN.members_
for k, v in pairs(list) do
x = x + 1
...
if TEAMLODKNSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevTEAMLODKNW(msg) then 
...
if text == ("ردود المطور") and DevTEAMLODKNW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ♰︙قائمة ردود المطور \n*•━━━━━━ 𝖫ꪀ ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevTEAMLODKNW(msg) then    
send(msg.chat_id_, msg.id_,' *♰︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevTEAMLODKNW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'لودكن').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevTEAMLODKNW(msg) then   
...
if text == 'تعطيل المغادره' and DevTEAMLODKNW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'f55f5')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
TEAMLODKNdx(msg.chat_id_, msg.id_, ' *♰︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*♰︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*♰︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*♰︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevTEAMLODKNW(msg) then
...
{{text = '𝗟𝗼𝗱𝗞𝗻 𝗧𝗲𝗮𝗺 .', url="t.me/f55f5"}},
{{text = 'مطور السورس', url="t.me/ckcck"}},
}
...
send(msg.chat_id_, msg.id_, t..'ٴ♰∫ٴ*•━━━━━━ 𝖫ꪀ ━━━━━━━•*ٴ♰∫○ٴ\n♰︙[𝗟𝗼𝗱𝗞𝗻 𝗧𝗲𝗮𝗺 .](t.me/f55f5) ')
end
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʟᴏᴅᴋɴ',url='http://t.me/f55f5'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'لودكن')
...
TEAMLODKN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TEAMLODKN)
...
--------------------------------------------------------------------------------------------------------------
SourceTEAMLODKN(data.message_,data)
...
------------------------------------------------------------------------
local TEAMLODKNAbot = database:get(bot_id.."TEAMLODKN1:Add:Filter:Rp2"..text..result.chat_id_)   
if TEAMLODKNAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *♰︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n♰︙["..TEAMLODKNAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local TEAMLODKN1_Msg = database:get(bot_id.."TEAMLODKN1:Add:Filter:Rp2"..text..result.chat_id_)   
if TEAMLODKN1_Msg then
send(msg.chat_id_, msg.id_," ♰︙"..TEAMLODKN1_Msg)
