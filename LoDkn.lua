...
if DevFLoRXW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LODKN/Files_FLoRX/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LODKN/Files_FLoRX/main/File_Bot/"..file)
if res == 200 then
